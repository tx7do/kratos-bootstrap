...
var file_conf_v1_kratos_conf_authn_proto_goTypes = []interface{}{
...
func file_conf_v1_kratos_conf_authn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_conf_v1_kratos_conf_authn_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conf_v1_kratos_conf_authn_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Authentication_Jwt); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_conf_v1_kratos_conf_authn_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
