...
require (
	github.com/go-kratos/kratos/contrib/config/apollo/v2 v2.0.0-20250429074618-c82f7957223f
	github.com/go-kratos/kratos/contrib/config/etcd/v2 v2.0.0-20250429074618-c82f7957223f
	github.com/go-kratos/kratos/contrib/config/kubernetes/v2 v2.0.0-20250429074618-c82f7957223f
