module github.com/tx7do/kratos-bootstrap/script_engine/source/consul
...
// TODO: 当 go-scripts/source/consul 发布后，添加以下依赖:
// require github.com/tx7do/go-scripts/source/consul v0.0.0
